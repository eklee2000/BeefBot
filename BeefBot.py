...
async def msgAnal(ctx):
    ...
    pieDf = df.head(15)
    piePlot = (pieDf.plot(x = "Name", y = "Messages Sent", kind = "pie", autopct = '%1.1f%%', figsize = (13,10)))
    piePlot.legend(bbox_to_anchor=(0.85,0.9), bbox_transform=plt.gcf().transFigure)
